...
public class CalculatorServiceLocator extends org.apache.axis.client.Service implements com.bindu.CalculatorService {
    ...
    private java.lang.String Calculator_address = "http://192.168.1.3:8181/SOAPWebServiceDemo/services/Calculator";
    ...
    public com.bindu.Calculator getCalculator() throws javax.xml.rpc.ServiceException {
    ...
    public com.bindu.Calculator getCalculator(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.bindu.CalculatorSoapBindingStub _stub = new com.bindu.CalculatorSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.bindu.Calculator.class.isAssignableFrom(serviceEndpointInterface)) {
                com.bindu.CalculatorSoapBindingStub _stub = new com.bindu.CalculatorSoapBindingStub(new java.net.URL(Calculator_address), this);
                _stub.setPortName(getCalculatorWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://bindu.com", "CalculatorService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://bindu.com", "Calculator"));
        }
