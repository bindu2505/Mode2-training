...
public class RetrieveLogic
{
    ...
    public void retrieveEmployee()
    {
        ...
        List<Employee> employeeList = employeeRepository.findEmpByCountrySortState("Country 3","state");
		...
		/*
		 * List<Employee> emplist=employeeRepository.findEmpByCountry("Country 2"); for
		 * (Employee employee : emplist) { System.out.println(employee); }
		 * 
		 * System.out.println("new"); List<Employee>
		 * emplist1=employeeRepository.findEmpByCountrySortState("Country 1","state");
		 * for (Employee employee : emplist1) { System.out.println(employee); }
		 */
