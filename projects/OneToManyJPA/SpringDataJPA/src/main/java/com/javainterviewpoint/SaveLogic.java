...
public class SaveLogic 
{
    ...
    public void saveEmployee()
    {
        ...
        employeeAddress3.setStreet("Street 3");
        employeeAddress3.setCity("City 3");
        employeeAddress3.setCountry("Country 3");
        employeeAddress3.setState("State 2");
        employeeAddress3.setEmployee(employee);
        
        Employee_Address employeeAddress4 = new Employee_Address();
        employeeAddress4.setStreet("Street 4");
        employeeAddress4.setCity("City 4");
