...
public class RestEasyTestClient {
	...
	public static void main(String[] args) {
		...
		//GET example
		ResteasyWebTarget getDummy = client.target("http://localhost:4444/RestEasy-Example/employee/99/getDummy");
        ...
        //POST example
		ResteasyWebTarget add = client.target("http://localhost:4444/RestEasy-Example/employee/add");
		...
		//DELETE example
		ResteasyWebTarget delete = client.target("http://localhost:4444/RestEasy-Example/employee/50/delete");
